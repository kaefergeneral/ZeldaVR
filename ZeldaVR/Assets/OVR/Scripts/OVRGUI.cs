...
public class OVRGUI
{
    ...
    public void StereoDrawTexture(int X, int Y, ref Texture image, Color color)
    {
        StereoDrawTexture(X, Y, image.width, image.height, ref image, color);
    }
    public void StereoDrawTexture(float X, float Y, ref Texture image, Color color)
    {
        StereoDrawTexture ((int)(X * PixelWidth),
                           (int)(Y * PixelHeight),
                           (int)(image.width * PixelWidth),
                           (int)(image.height * PixelHeight),
                            ref image, color);
    }


    public void StereoLabel(int X, int Y, int wX, int hY, ref string text, Color color)
    {
        Font prevFont = GUI.skin.font;
        GUI.color = color;
        // Make sure to change font if it needs replacement
