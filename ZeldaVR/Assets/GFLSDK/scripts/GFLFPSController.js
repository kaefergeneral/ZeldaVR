...
function Update () {
	...
	if (autowalk==1)
		directionVector=Vector3(0,0,1*inhibit_autowalk);
	...
	if(ground_gameobject!=null)
		last_ground_pos=ground_gameobject.transform.position;
}
