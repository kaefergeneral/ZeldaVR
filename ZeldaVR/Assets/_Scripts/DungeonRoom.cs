...
public class DungeonRoom : MonoBehaviour 
{
    ...
    public void SetWallTypeForDirection(DungeonRoomInfo.WallDirection direction, DungeonRoomInfo.WallType type)
    {
        ...
        wall.renderer.material = DungeonFactory.Instance.GetWallMaterial(direction, type);
    ...
    public void OnPushableWasPushedIntoPosition()
    {
        ...
        {
            SpawnSubDungeon();
            floor.renderer.material = Info.PushBlockChangeFloorMaterial;
        }
    ...
    {
        Texture2D floorTexture = floor.renderer.material.mainTexture as Texture2D;
