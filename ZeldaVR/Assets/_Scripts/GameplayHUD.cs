...
public class GameplayHUD : Singleton<GameplayHUD>
{
    ...
    {
        _owMapBgTexture = StereoscopicGUI.CreateColoredTexture(_owMapBgColor);
        _owMapSectorTexture = StereoscopicGUI.CreateColoredTexture(_owMapSectorColor);

        _dungeonMapBgTexture = StereoscopicGUI.CreateColoredTexture(_dungeonMapBgColor);
        _dungeonMapSectorTexture = StereoscopicGUI.CreateColoredTexture(_dungeonMapSectorColor);
        _dungeonMapLinkTexture = StereoscopicGUI.CreateColoredTexture(_dungeonMapLinkColor);
        _dungeonMapBossTexture = StereoscopicGUI.CreateColoredTexture(_dungeonMapBossColor);
    }
