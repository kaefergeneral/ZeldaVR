...
function Start () {
	...
	{
	    render.material.color.a = 0;
	
	    yield WaitForSeconds(0.5);
	
	    yield FadeMaterial(render.material, fadeTime, Fade.In);
	
	    yield WaitForSeconds(0.25);
	
	    yield FadeMaterial(render.material, fadeTime, Fade.Out);
...
function FadeMaterial (mat : Material, timer : float, fadeType : Fade) {
    ...
    while (i < 1.0) {
        ...
        mat.color.a = Mathf.Lerp(start, end, i)*.5;
